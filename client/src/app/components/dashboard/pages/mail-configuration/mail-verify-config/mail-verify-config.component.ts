...
@Component({
  selector: 'app-mail-verify-config',
  templateUrl: './mail-verify-config.component.html',
  styleUrls: ['./mail-verify-config.component.scss'],
})
export class MailVerifyConfigComponent implements OnInit {
  public path = '/forms/mail-config';
  public file = 'verify.json';
  public data: any;
  public config: any;
